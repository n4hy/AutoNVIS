...
class TECDisplayMainWindow(QMainWindow):
    ...
    def _show_about(self):
        ...
        QMessageBox.about(
            ...
            "<h3>AutoNVIS TEC Display</h3>"
            "<p><b>Author:</b> N4HY</p>"
            "<hr>"
            "<p><b>Description:</b><br>"
            "Real-time visualization of Total Electron Content (TEC) from "
            "the NOAA GloTEC (Global TEC) assimilation model.</p>"
            "<p><b>Display Panels:</b></p>"
            "<ul>"
            "<li><b>Global TEC Map:</b> Color-coded world map showing ionospheric "
            "TEC values in TECU (10^16 electrons/m²). Higher TEC = higher MUF. "
            "Click to select a tracking point.</li>"
            "<li><b>TEC Time Series:</b> Historical TEC values. Shows global mean "
            "and selected point values over time.</li>"
            "<li><b>Ionosphere Profile:</b> Vertical structure parameters including "
            "hmF2 (F2-layer peak height) and NmF2 (peak electron density).</li>"
            "</ul>"
            "<p><b>What TEC Tells You:</b></p>"
            "<ul>"
            "<li><b>High TEC (>40 TECU):</b> Strong ionosphere, higher MUF, better "
            "DX conditions on higher bands (15m-10m)</li>"
            "<li><b>Low TEC (<15 TECU):</b> Weak ionosphere, lower MUF, only lower "
            "bands (40m-80m) usable for skywave</li>"
            "<li><b>TEC gradients:</b> Indicate potential ionospheric irregularities "
            "and scintillation zones</li>"
            "</ul>"
            "<p><b>Data Source:</b></p>"
            "<ul>"
            "<li>NOAA SWPC GloTEC model</li>"
            "<li>Assimilates GNSS measurements from global receiver network</li>"
            "<li>Update cadence: 10 minutes</li>"
            "<li>Spatial resolution: 1° x 1° global grid</li>"
            "</ul>"
            "<p><b>Controls:</b></p>"
            "<ul>"
            "<li>Connect: Toggle connection to data source</li>"
            "<li>Political: Toggle political boundaries overlay</li>"
            "<li>Clear Data: Clear historical time series</li>"
            "</ul>"
            "<hr>"

#!/usr/bin/env python3
"""
Create a standalone distribution ZIP file for Solar Imaging Display.
...
Output:
    solar-imaging-display-v1.0.0.zip
"""
...
VERSION = "1.0.0"
DIST_NAME = f"solar-imaging-display-v{VERSION}"
...
def create_distribution():
    ...
    solarimaging_dir = package_dir / "solarimaging"
    solarimaging_dir.mkdir()
    ...
    for filename in package_files:
        ...
        if src.exists():
            shutil.copy(src, solarimaging_dir / filename)
            print(f"  + solarimaging/{filename}")
        else:

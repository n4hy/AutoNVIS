#!/bin/bash
#
# Solar Imaging Display - Installation Script
#
# This script creates a Python virtual environment and installs
# all required dependencies for the Solar Imaging Display application.
#
# Usage: ./install.sh
#
...
echo ""
echo "=============================================="
echo "   Solar Imaging Display - Installer"
echo "=============================================="
echo ""
...
if python -c "import PyQt6.QtWidgets; import aiohttp; print('OK')" &> /dev/null; then
    success "All packages imported successfully"
else
    error "Package verification failed."
    echo "Try reinstalling: pip install --force-reinstall PyQt6 aiohttp"
    exit 1
fi
...
echo "=============================================="
echo ""
echo "To run the Solar Imaging Display:"
echo ""
echo "    ./run.sh"
echo ""
echo "Or manually:"
...
echo "    python -m solarimaging.main_direct"
echo ""
